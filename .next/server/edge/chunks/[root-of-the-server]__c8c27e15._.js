(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__c8c27e15._.js",
...
function extractSubdomain(request) {
    ...
    const rootDomainFormatted = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["rootDomain"].split(':')[0];
...
async function middleware(request) {
    ...
    if (subdomain) {
        ...
        if (pathname === '/') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL(`/s/${subdomain}`, request.url));
        }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8c27e15._.js.map